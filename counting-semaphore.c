...
/*
 * 10 conference rooms are in a building and access to them is controlled by the 
 * receptionist. On the desk is a display/counter that gets increased each time a room 
 * is free or decreased each time a room is claimed. The counter on the desk is a 
 * counting semaphore.
 */
